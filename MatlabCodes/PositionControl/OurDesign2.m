...
%% New pose in paper 
% % positive gains
% X0 = [2.5    -2      -1.5       1        -1      1.5];
% Y0 = [ 0      1        0        2        -2.25   -1.5];
% Th0 = [pi   3*pi/4    -pi/2     -pi/6    pi/2    -pi/3];
% negative gains
X0 = [2.25       0     -1.5    -2      -1        2];
Y0 = [1          2      1.5     0      -2.25   -1.25];
Th0 = [-pi/3   3*pi/4   -3*pi/4  pi/6     0       2*pi/3];
