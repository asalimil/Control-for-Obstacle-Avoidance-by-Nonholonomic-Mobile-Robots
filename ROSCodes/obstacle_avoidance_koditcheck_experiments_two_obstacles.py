...
# initial point
x0 = -1.0; y0 = -1.5; th0 = 0.0*math.pi/2
# alpha = 0.0
...
while ne > 0.05:
    ...
    O1 = numpy.array([-1.0, 0.5])
    O2 = numpy.array([+0.0, 1.0])
    #
    rarena = 2.25; r1 = 0.125; r2 = 0.15
    #
    darena = LA.norm(Xr[0:2]-Oarena)
    d1 = LA.norm(Xr[0:2]-O1);
    d2 = LA.norm(Xr[0:2]-O2)    
    #
    ...
    # beta
    beta = beta_arena*beta_1*beta_2
    # betadot
    betadot =  betadot_arena*beta_1*beta_2 + beta_arena*betadot_1*beta_2 + beta_arena*beta_1*betadot_2
    #
