...
# initial position
x0 = -3.0; y0 = -1.0; th0 = 0.0*math.pi/2
# alpha = 0.0
...
while ne > 0.05:
    ...
    O2 = numpy.array([-1.5, -1.0])
    O3 = numpy.array([-2.5, -0.5])
    #
    r1 = 0.125; r2 = 0.15; r3 = 0.15
    #
    ...
    grad_U_rep = grad_U_rep_1 + grad_U_rep_2 + grad_U_rep_3
