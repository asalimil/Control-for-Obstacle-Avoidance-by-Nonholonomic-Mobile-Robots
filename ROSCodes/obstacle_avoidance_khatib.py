...
def robot_move(X0,X):
    ...
    #
    r1 = 0.2; r2 = 0.125; r3 = 0.15; r4 = 0.15; r5 = 0.2; r6 = 0.175
    #
    ...
    # D1 = numpy.power(LA.norm(Xr[0:2]-O1), 2) - r1*r1; D1_dot = 2*(Xr - O1)
    # D2 = numpy.power(LA.norm(Xr[0:2]-O2), 2) - r2*r2; D2_dot = 2*(Xr - O2)
    # D3 = numpy.power(LA.norm(Xr[0:2]-O3), 2) - r3*r3; D3_dot = 2*(Xr - O3)
    # D4 = numpy.power(LA.norm(Xr[0:2]-O4), 2) - r4*r4; D4_dot = 2*(Xr - O4)
    # D5 = numpy.power(LA.norm(Xr[0:2]-O5), 2) - r5*r5; D5_dot = 2*(Xr - O5)
    # D6 = numpy.power(LA.norm(Xr[0:2]-O6), 2) - r6*r6; D6_dot = 2*(Xr - O6)
    #
